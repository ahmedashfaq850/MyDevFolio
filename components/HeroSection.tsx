...
const HeroSection = () => {
  return (
    <div className='h-[80vh] md:h-[80vh] z-25 m-2 flex justify-center items-center overflow-hidden'>
      ...
      <div className="herodiv">
        ...
        <p className="heroDescription text-[9px] md:text-[20px] mb-[20px] md:mb-5 leading-[20px] md:leading-[40px]">
        ...
        <Link href="/Ahmed Ashfaq CV.pdf" target="_blank"><button className='button-gradient  w-[300px] h-[45px] p-3 rounded-full flex items-center justify-center text-center gap-2 text-[18px] font-bold text-white bg-red-300'>Download My Resume <Image className='inline-flex' src="/downloadIcon.svg" width={30} height={30} alt="" /></button></Link>
