...
const ContactSection = () => {
  return (
    <div className='relative mt-[130px] mb-[100px] flex justify-center'>
      ...
      <div className='contactContainer flex flex-col gap-[15px] md:gap-[0px] md:flex-row md:justify-between p-[15px] md:p-[15px] items-start md:items-center'>
        <p className='text-white text-[18px] md:text-[25px] font-[700] w-[100%] md:w-[450px]'>Want me building stuff for you ? Hit me on
          Linkedin</p>
