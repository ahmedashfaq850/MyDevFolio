...
const TestimonialSection = () => {
  return (
    <div className='mt-[50px] mb-[50px] relative'>
      <h1 className='text-center text-white text-[20px] md:text-[48px] font-bold flex items-center gap-2 justify-center'>What Client Say about Me<Image className='inline-flex' src="/ClientIcon.svg" width={50} height={50} alt="" /></h1>
      <div className='flex justify-center mr-[220px] md:mr-[525px] mt-[5px]'><Image src="/newstripe.png" width="63" height="13" alt="" /></div>
